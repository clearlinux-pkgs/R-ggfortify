...
Version  : 0.4.18
Release  : 22
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/ggfortify_0.4.18.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/ggfortify_0.4.18.tar.gz
...
%setup -q -n ggfortify
pushd ..
cp -a ggfortify buildavx2
popd
pushd ..
cp -a ggfortify buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1751549939
